# Ubuntu 26.04 software differences

The pinned upstream preview x64 toolset and installer chain is the software
baseline; Qiniu-specific changes are limited to container-safe service setup,
the ephemeral Actions runner, the `runner` filesystem contract, and direct
...
GitHub Releases API during the build. The upstream PowerShell module installers
and Pester assertions still run unchanged.
