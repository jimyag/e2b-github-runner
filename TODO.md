...
- Complete the Issue #38 release gate: use qshell to build and publish all four
  physical public runner templates in `cn-yangzhou-1` and `us-south-1`, retain
  catalog and Sandbox smoke evidence, verify all five logical workflow labels,
  and only then mark the template matrix verified and close the issue.
