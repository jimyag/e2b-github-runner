...
- [User-scoped Runner Configuration](user-scoped-runner-configuration.md): active, not-yet-implemented handoff plan covering requirements, architecture, execution, testing, acceptance, rollback, and result recording for account- and organization-scoped Runner management.
- [Implementation Plan Archive](superpowers/plans/README.md): completed or retired execution plans retained for design rationale; unchecked historical checklists are not active roadmap work.
