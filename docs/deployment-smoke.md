...
- Active requests recover with bounded concurrency instead of waiting for every earlier request serially; one slow request does not consume another request's entire recovery budget.
